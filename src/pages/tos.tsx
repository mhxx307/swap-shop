    ...
    return (
        <>
            ...
            <div className="wrapper py-[100px] space-y-9">
                ...
                <h4 className="text-xl font-semibold">2. {t('heading2')}</h4>
                <p className="text-sm">{t('heading2_paragraph_1')}</p>
                <p className="text-sm">{t('heading2_paragraph_2')}</p>

                <h4 className="text-xl font-semibold">3. {t('heading3')}</h4>
                <p className="text-sm">{t('heading3_paragraph_1')}</p>

                <h4 className="text-xl font-semibold">4. {t('heading4')}</h4>
                ...
                <h4 className="text-xl font-semibold">5. {t('heading5')}</h4>
                ...
                <h4 className="text-xl font-semibold">6. {t('heading6')}</h4>
                ...
                <h4 className="text-xl font-semibold">7. {t('heading7')}</h4>
                <p className="text-sm">{t('heading7_paragraph_1')}</p>
                <p className="text-sm">{t('heading7_paragraph_2')}</p>

                <h4 className="text-xl font-semibold">8. {t('heading8')}</h4>
